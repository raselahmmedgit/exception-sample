    ...
    public class ProductController : Controller
    {
        ...
        public JsonResult Create(Product product)
        {
            try
            {
                ...
                return Json(new { msg = ExceptionHelper.ModelStateErrorFormat(ModelState), status = MessageType.information.ToString() }, JsonRequestBehavior.AllowGet);
        ...
        public JsonResult Edit(Product product)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    return Json(new { msg = "Product is null.", status = MessageType.information.ToString() }, JsonRequestBehavior.AllowGet);
